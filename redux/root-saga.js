...
export default function* rootSaga() {
    yield all([fork(productSaga), fork(checkoutSagas), fork(homeSagas), fork(shopSagas), fork(userSaga), fork(cartSagas), fork(wishlistSagas), fork(ordersSagas), fork(searchSagas)]);
}