...
const Loader = ({ message = '', children }) => (
    <div className="flex justify-center flex-col items-center w-full h-full " style={{ minHeight: '95vh' }}>
        <div className="h-40 w-40 mb-3">
            {children ||
        ...
        {
            !!message &&
            // <div className="test-sm font-semibold animate-bounce">
            <div className={`test-sm font-medium ${!children && 'animate-bounce'}`}>
                {message}
            </div>
        }
    </div>
