...
export default function* productSaga() {
    yield all([call(onProductFetchStart), call(onSimilarProductFetchStart), call(onGetSpecificationsStart), call(onGetAdditionalInfoStart), call(onGetVariantsStart)])
}